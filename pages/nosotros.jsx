    ...
    <div className="container" style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 100, alignItems: "start" }}>
      ...
      <div className="reveal" style={{ display: "flex", flexDirection: "column", gap: 28 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 20, marginTop: 20 }}>
          <div className="img-hover" style={{ aspectRatio: "4/5" }}><img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=900&q=80" alt="" /></div>
          <div className="img-hover" style={{ aspectRatio: "4/5", marginTop: 50 }}><img src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=900&q=80" alt="" /></div>
        </div>
      </div>
    </div>
  </section>
